...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left — Brand Panel */}
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between bg-foreground p-12 text-primary-foreground relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 -left-20 h-[500px] w-[500px] rounded-full bg-primary blur-[120px]" />
          <div className="absolute bottom-20 right-10 h-[400px] w-[400px] rounded-full bg-accent blur-[100px]" />
        </div>
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="font-display text-xl font-bold">Board Vault</span>
          </div>
          <p className="text-sm text-primary-foreground/50">Governance Portal</p>
        </div>
