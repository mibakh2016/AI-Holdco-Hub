...
const sampleMessages: Message[] = [
  {
    id: "1",
    role: "user",
    text: "What are the terms of my subscription agreement?",
  },
  {
    id: "2",
    role: "assistant",
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        {
          ...
          role: "assistant",
          text: "I don't have enough information to answer this accurately — please contact management.",
        },
      ]);
    }, 1200);
  };
    ...
    <div className="flex gap-6 h-[calc(100vh-8rem)] max-w-6xl">
      ...
      <div className="flex-1 flex flex-col glass-card rounded-xl overflow-hidden">
        <div className="p-4 border-b flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold font-display">Document Assistant</p>
            <p className="text-[11px] text-muted-foreground">Answers from verified governance documents only</p>
          </div>
          <Badge variant="outline" className="ml-auto text-[10px] text-accent border-accent/30">RAG-Powered</Badge>
        </div>
      ...
      <div className="hidden xl:flex w-[380px] glass-card rounded-xl items-center justify-center">
